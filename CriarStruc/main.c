...
int main(void)
{
    ...
    fflush(stdin);
    fgets(aluno.nome, 40, stdin); //(fgets) Instrução para ler strings. fgets(variavel, tamanho da string, entrada)
    //Neste caso, a entrada é stdin (entrada padrão), pois estamos lendo do teclado
    printf("Disciplina ......: ");
    fflush(stdin);
    fgets(aluno.disciplina, 40, stdin); // (fgets) Instrução para ler strings. fgets(variavel, tamanho da string, entrada)
    //Neste caso, a entrada é stdin (entrada padrão), pois estamos lendo do teclado
